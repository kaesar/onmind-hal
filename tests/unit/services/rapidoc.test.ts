...
import { RapiDocService } from '../../../src/services/optional/rapidoc.js';
...
describe('RapiDocService', () => {
  let service: RapiDocService;
  ...
  beforeEach(() => {
    ...
    service = new RapiDocService(config, templateEngine);
  });

  it('should have correct service name', () => {
    expect(service.name).toBe('RapiDoc');
  });

  it('should have correct service type', () => {
    expect(service.type).toBe(ServiceType.RAPIDOC);
  });
