...
export class CaddyService extends BaseService {
  ...
  private getServiceProxyConfig(): Array<{name: string, subdomain: string, port: number, container: string}> {
    const serviceProxyMap = {
      ...
      [ServiceType.SEND]: { subdomain: 'send', port: 1880, container: 'send' },
      [ServiceType.FILESTASH]: { subdomain: 'filestash', port: 8334, container: 'filestash' },
      [ServiceType.SEAFILE]: { subdomain: 'drive', port: 80, container: 'seafile' },
      ...
      [ServiceType.ORCAROUTERLITE]: { subdomain: 'orcarouter', port: 8000, container: 'orcarouterlite' },
      ...
      [ServiceType.OPENHUMAN]: { subdomain: 'openhuman', port: 7788, container: 'openhuman' },
